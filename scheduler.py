...
class Scheduler:
    ...
    def cleanup_files(company):
        """Clean up temporary files while preserving results"""
        ...
        # Remove temporary files but preserve Results.csv
    ...
    @staticmethod
    def main():
        # Clear Results.csv at start if it exists
        if os.path.exists("resources2/Results.csv"):
            os.remove("resources2/Results.csv")
        ...
        # Create final performance grid only once at the end
